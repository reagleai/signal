...
export default function AIInsights() {
    ...
    return (
        <div className="max-w-[1200px] mx-auto px-4 sm:px-8 py-6 sm:py-8" id="section-ai-insights" role="tabpanel" aria-label="AI Insights">
            <div className="flex flex-col xl:flex-row gap-6 items-start">
                    ...
                    <div className="flex flex-col gap-3 mb-8">
                        {masterProblems.map(problem => {
                            ...
                            return (
                                <div
                                    key={problem.id}
                                    className="bg-white border rounded-xl shadow-sm overflow-hidden cursor-pointer transition-all duration-150"
                                    style={{
                ...
                <div className="flex-[2] min-w-0 w-full xl:w-auto xl:sticky xl:top-4">
                    ...
                    <div className="bg-white border border-[#E8EAED] rounded-xl shadow-sm overflow-hidden flex flex-col" style={{ maxHeight: '46vh' }}>
                        <div className="p-3 sm:p-4 border-b border-[#F0F0F0] flex-shrink-0 flex items-center justify-between">
                            ...
                            {selected && (
                                <span className="bg-[#FFF8EE] text-[#B7791F] border border-[#FF9900]/20 rounded-full px-2 sm:px-2.5 py-1 text-[10px] sm:text-[11px] font-medium max-w-[120px] sm:max-w-[140px] overflow-hidden whitespace-nowrap text-ellipsis">{selected.title}</span>
                            )}
                        </div>
                        {!state.selectedProblemId ? (
                            ...
                            <div className="flex-1 overflow-y-auto p-3 sm:p-4 flex flex-col gap-3">
                                {visibleCitations.map(citation => (
                                    <div key={citation.id} className="bg-[#F7F8FA] rounded-xl overflow-hidden" style={{ borderLeft: `3px solid ${citation.sourceColor}` }}>
                    ...
                    <div className="bg-white border border-[#E8EAED] rounded-xl shadow-sm overflow-hidden flex flex-col mt-4" style={{ maxHeight: '46vh' }}>
                        <div className="p-3 sm:p-4 border-b border-[#F0F0F0] flex-shrink-0 flex items-center justify-between">
                            <div className="flex items-center gap-2">
